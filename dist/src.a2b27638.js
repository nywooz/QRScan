...
function startScanner() {
  ...
  state.enableScan = true; // Use facingMode: environment to attemt to get the front camera on phones
...
function tick() {
  ...
  if (video.readyState === video.HAVE_ENOUGH_DATA) {
    ...
    if (code) {
      drawLine(code.location.topLeftCorner, code.location.topRightCorner, state.color);
      drawLine(code.location.topRightCorner, code.location.bottomRightCorner, state.color);
      drawLine(code.location.bottomRightCorner, code.location.bottomLeftCorner, state.color);
      drawLine(code.location.bottomLeftCorner, code.location.topLeftCorner, state.color);
      ...
      if (code.data && code.data.includes("https:")) {
        ...
        outputData.appendChild(link); // outputData.innerText = code.data;
      ...
      scanBtn.disabled = true; //scanBtn.setAttribute("disabled", "");
